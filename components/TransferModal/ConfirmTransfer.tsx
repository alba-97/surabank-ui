    ...
    <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }}>
      ...
      <div className="bg-[#f9fafc] rounded-2xl p-5 mb-6 flex flex-col gap-4">
        <div className="flex justify-between">
          <span className="text-[#aaa] text-sm">Tarjeta</span>
          <span className="text-[#334154] text-sm font-medium text-right">
            {selectedCard
        ...
        <div className="flex justify-between">
          <span className="text-[#aaa] text-sm">Para</span>
          <span className="text-[#334154] text-sm font-medium text-right max-w-[200px] truncate">
            {recipientName || recipientEmail}
          </span>
        </div>
        <div className="border-t border-[#e5e7eb]" />
        <div className="flex justify-between">
          <span className="text-[#aaa] text-sm">Monto</span>
          <span className="text-[#334154] text-lg font-semibold">
            ${amount}
          </span>
        </div>
      </div>
